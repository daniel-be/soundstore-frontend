...
var routes = [
    ...
    { path: 'account/:email', component: account_detail_component_1.AccountDetailComponent },
    { path: 'search/:pattern', component: song_search_component_1.SongSearchComponent }
];
